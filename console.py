...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, args):
        ...
        if classmatch is not None:
            ...
            params_string = args[len(classname):].strip()
            ...
            for param in params:
                parammatch = re.fullmatch(param_pattern, param)
                if parammatch is not None:
                    key_name = parammatch.group('name')
                    str_val = parammatch.group('t_str')
                    float_val = parammatch.group('t_float')
                    int_val = parammatch.group('t_int')
        ...
        if os.getenv('HBNB_TYPE_STORAGE') == 'db':
            ...
            new_instance = HBNBCommand.classes[classname](**obj_kwargs)
            new_instance.save()
